...
$THEME->scss = function($theme) {
    return theme_boostcgs_get_main_scss_content($theme);
};
...
$THEME->layouts = [
    ...
    'frontpage' => array(
        'file' => 'frontpage.php',
        //'regions' => array('side-pre', 'fp-main-top', 'fp-main-bottom', 'fp-main-right'),
        'regions' => array('side-pre', 'fp-main-top', 'fp-main-bottom'),
